                ...
                <tbody>
                  ...
                  foreach($req as $row){
                    ...
                    <tr>
                        ...
                        <td>
                            <button class='btn btn-success btn-sm edit btn-flat' data-id="<?php echo $row['CodeUser'] ?>"><i class='fa fa-edit'></i> Modifier</button>
                            <button class='btn btn-danger btn-sm delete btn-flat' data-id="<?php echo $row['CodeUser'] ?>"><i class='fa fa-trash'></i> Supprimer</button>
                        </td>
                    </tr>
                    <?php
                  }
