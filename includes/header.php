...
<header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-lg"><b>SOFT </b>Recensement</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo $req['NomAgent'].' '.$req['PostnomAgent']; ?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                <?php echo $req['NomAgent'].' '.$req['PostnomAgent']; ?>
                  <small>Membre depuis <?php echo $app->dateconv($req['user_created_on']); ?></small>
                </p>
              </li>
              <!-- Menu Body -->
