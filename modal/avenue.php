    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><b>Modifier l'avenue'</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="manager/update.php">
                <input type="hidden" class="avenue" name="id">
                <input type="hidden" name="event" value="UPDATE_AVENUE">
                <div class="form-group">
                    <label for="edit_avenue" class="col-sm-3 control-label">avenue</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="manager/delete.php">
                <input type="hidden" class="avenue" name="id">
                <input type="hidden" name="event" value="DELETE_AVENUE">
                <div class="text-center">
                    <p>SUPPRIMER L'AVENUE</p>
