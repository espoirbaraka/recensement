    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><b>Ajouter un quartier / groupement</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="manager/create.php" enctype="multipart/form-data">
                <div class="form-group">
                    <input type="hidden" class="commune" name="id">
                    <input type="hidden" name="event" value="CREATE_QUARTIER" required>
                    <label for="quartier" class="col-sm-3 control-label">Designation</label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      ...
                      <?php
                        $sql = "SELECT * FROM t_statut_quartier";
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><b>Modifier la commune/ secteur/ chefferie</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="manager/update.php">
                <input type="hidden" class="commune" name="id">
                <input type="hidden" name="event" value="UPDATE_COMMUNE">
                <div class="form-group">
                    <label for="edit_commune" class="col-sm-3 control-label">Commune/ Secteur/ Chefferie</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="manager/delete.php">
                <input type="hidden" class="commune" name="id">
                <input type="hidden" name="event" value="DELETE_COMMUNE">
                <div class="text-center">
                    <p>SUPPRIMER LA COMMUNE/ SECTEUR/ CHEFFERIE</p>
